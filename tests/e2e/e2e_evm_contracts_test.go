...
func (suite *IntegrationTestSuite) TestEthCallToErc20() {
	...
	beforeBalance := suite.GetErc20Balance(suite.DeployedErc20Address, randoReceiver)
	...
	afterBalance := suite.GetErc20Balance(suite.DeployedErc20Address, randoReceiver)
...
func (suite *IntegrationTestSuite) TestEip712ConvertToCoinAndDepositToEarn() {
	...
	balance := suite.GetErc20Balance(suite.DeployedErc20Address, depositor.EvmAddress)
