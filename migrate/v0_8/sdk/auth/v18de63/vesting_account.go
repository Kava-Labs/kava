...
// func NewBaseVestingAccount(baseAccount *BaseAccount, originalVesting sdk.Coins, endTime int64) (*BaseVestingAccount, error) {
...
// func NewPeriodicVestingAccount(baseAcc *BaseAccount, startTime int64, periods Periods) *PeriodicVestingAccount {
// 	endTime := startTime
