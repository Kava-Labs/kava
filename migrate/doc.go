...
- **genesis migration** that converts an exported genesis file from the old software to a new genesis file for the new software
- **upgrade module migration** that converts data in the database itself from the old version to the new
...
- probably uses copypasted old keeper and types to read from db, convert to current types and write with current keeper
