...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/kava-labs/cosmos-sdk v0.45.3-kava.1
	...
	github.com/tharsis/ethermint => github.com/Kava-Labs/ethermint v0.14.0-kava-v17.1
