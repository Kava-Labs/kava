...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/kava-labs/cosmos-sdk v0.45.9-kava.3
	...
	github.com/tharsis/ethermint => github.com/kava-labs/ethermint v0.14.0-kava-v19.2
