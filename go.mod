...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/kava-labs/cosmos-sdk v0.0.0-20241028041437-cd854853a87f
	...
	github.com/evmos/ethermint => github.com/kava-labs/ethermint v0.0.0-20241028041605-1024e8aafd14
