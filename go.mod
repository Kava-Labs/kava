...
require (
	cosmossdk.io/store v0.0.0-20230223172449-e9fcb35b61fb
	...
	github.com/evmos/ethermint v0.14.0
...
replace (
	...
	github.com/evmos/ethermint => github.com/kava-labs/ethermint v0.21.0-kava-v0.22
)
