<!--
title: multisign-batch
-->
## kava tx multisign-batch
...
Example:
$ kava tx multisign-batch transactions.json multisigk1k2k3 k1sigs.json k2sigs.json k3sig.json

The current multisig implementation defaults to amino-json sign mode.
The SIGN_MODE_DIRECT sign mode is not supported.'

```
kava tx multisign-batch [file] [name] [[signature-file]...] [flags]
```
