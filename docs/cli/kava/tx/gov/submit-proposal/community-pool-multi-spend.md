...
-->
## kava tx gov submit-proposal community-pool-multi-spend
...
```
kava tx gov submit-proposal community-pool-multi-spend [proposal-file] [flags]
```

### Examples

```
$ kava tx gov submit-proposal community-pool-multi-spend <path/to/proposal.json> --from=<key_or_address>
