...
func NewPricefeedGenState(cdc codec.JSONCodec, asset string, price sdkmath.LegacyDec) app.GenesisState {
...
func NewCDPGenState(cdc codec.JSONCodec, asset string, liquidationRatio sdkmath.LegacyDec) app.GenesisState {
	cdpGenesis := types.GenesisState{
		...
		PreviousAccumulationTimes: types.GenesisAccumulationTimes{
			types.NewGenesisAccumulationTime(asset+"-a", time.Time{}, sdkmath.LegacyOneDec()),
		},
		TotalPrincipals: types.GenesisTotalPrincipals{
			types.NewGenesisTotalPrincipal(asset+"-a", sdkmath.ZeroInt()),
		},
	}
...
func NewCDPGenStateMulti(cdc codec.JSONCodec) app.GenesisState {
	cdpGenesis := types.GenesisState{
		Params: types.Params{
			...
			CollateralParams: types.CollateralParams{
				...
				},
				{
					...
					DebtLimit:                        sdk.NewInt64Coin("usdx", 500000000000),
					StabilityFee:                     sdkmath.LegacyOneDec(), // %0 apr
					LiquidationPenalty:               d("0.05"),
		...
		CDPs:          types.CDPs{},
		PreviousAccumulationTimes: types.GenesisAccumulationTimes{
			types.NewGenesisAccumulationTime("btc-a", time.Time{}, sdkmath.LegacyOneDec()),
			types.NewGenesisAccumulationTime("xrp-a", time.Time{}, sdkmath.LegacyOneDec()),
			types.NewGenesisAccumulationTime("busd-a", time.Time{}, sdkmath.LegacyOneDec()),
			types.NewGenesisAccumulationTime("bnb-a", time.Time{}, sdkmath.LegacyOneDec()),
		},
		TotalPrincipals: types.GenesisTotalPrincipals{
			types.NewGenesisTotalPrincipal("btc-a", sdkmath.ZeroInt()),
			types.NewGenesisTotalPrincipal("xrp-a", sdkmath.ZeroInt()),
			types.NewGenesisTotalPrincipal("busd-a", sdkmath.ZeroInt()),
			types.NewGenesisTotalPrincipal("bnb-a", sdkmath.ZeroInt()),
		},
	}
	return app.GenesisState{types.ModuleName: cdc.MustMarshalJSON(&cdpGenesis)}
}
...
func cdps() (cdps types.CDPs) {
	...
	c1 := types.NewCDP(uint64(1), addrs[0], sdk.NewCoin("xrp", sdkmath.NewInt(10000000)), "xrp-a", sdk.NewCoin("usdx", sdkmath.NewInt(8000000)), tmtime.Canonical(time.Now()), sdkmath.LegacyOneDec())
	c2 := types.NewCDP(uint64(2), addrs[1], sdk.NewCoin("xrp", sdkmath.NewInt(100000000)), "xrp-a", sdk.NewCoin("usdx", sdkmath.NewInt(10000000)), tmtime.Canonical(time.Now()), sdkmath.LegacyOneDec())
	c3 := types.NewCDP(uint64(3), addrs[1], sdk.NewCoin("btc", sdkmath.NewInt(1000000000)), "btc-a", sdk.NewCoin("usdx", sdkmath.NewInt(10000000)), tmtime.Canonical(time.Now()), sdkmath.LegacyOneDec())
	c4 := types.NewCDP(uint64(4), addrs[2], sdk.NewCoin("xrp", sdkmath.NewInt(1000000000)), "xrp-a", sdk.NewCoin("usdx", sdkmath.NewInt(500000000)), tmtime.Canonical(time.Now()), sdkmath.LegacyOneDec())
