...
func ErrCdpAlreadyExists(codespace sdk.CodespaceType, owner sdk.AccAddress, denom string) error {
...
func ErrInvalidCollateralLength(codespace sdk.CodespaceType, length int) error {
...
func ErrCollateralNotSupported(codespace sdk.CodespaceType, denom string) error {
...
func ErrDebtNotSupported(codespace sdk.CodespaceType, denom string) error {
...
func ErrExceedsDebtLimit(codespace sdk.CodespaceType, proposed sdk.Coins, limit sdk.Coins) error {
...
func ErrInvalidCollateralRatio(codespace sdk.CodespaceType, denom string, collateralRatio sdk.Dec, liquidationRatio sdk.Dec) error {
...
func ErrCdpNotFound(codespace sdk.CodespaceType, owner sdk.AccAddress, denom string) error {
...
func ErrDepositNotFound(codespace sdk.CodespaceType, depositor sdk.AccAddress, cdpID uint64) error {
...
func ErrInvalidDepositDenom(codespace sdk.CodespaceType, cdpID uint64, expected string, actual string) error {
...
func ErrInvalidPaymentDenom(codespace sdk.CodespaceType, cdpID uint64, expected []string, actual []string) error {
...
func ErrDepositNotAvailable(codespace sdk.CodespaceType, cdpID uint64, depositor sdk.AccAddress) error {
...
func ErrInvalidCollateralDenom(codespace sdk.CodespaceType, denom string) error {
...
func ErrInvalidWithdrawAmount(codespace sdk.CodespaceType, withdraw sdk.Coins, deposit sdk.Coins) error {
...
func ErrCdpNotAvailable(codespace sdk.CodespaceType, cdpID uint64) error {
...
func ErrBelowDebtFloor(codespace sdk.CodespaceType, debt sdk.Coins, floor sdk.Int) error {
...
func ErrPaymentExceedsDebt(codespace sdk.CodespaceType, payment sdk.Coins, principal sdk.Coins) error {
...
func ErrLoadingAugmentedCDP(codespace sdk.CodespaceType, cdpID uint64) error {
