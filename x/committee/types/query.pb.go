...
type QueryTallyResponse struct {
	ProposalID    uint64                      `protobuf:"varint,1,opt,name=proposal_id,json=proposalId,proto3" json:"proposal_id,omitempty"`
	YesVotes      cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=yes_votes,json=yesVotes,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"yes_votes"`
	NoVotes       cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=no_votes,json=noVotes,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"no_votes"`
	CurrentVotes  cosmossdk_io_math.LegacyDec `protobuf:"bytes,4,opt,name=current_votes,json=currentVotes,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"current_votes"`
	PossibleVotes cosmossdk_io_math.LegacyDec `protobuf:"bytes,5,opt,name=possible_votes,json=possibleVotes,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"possible_votes"`
	VoteThreshold cosmossdk_io_math.LegacyDec `protobuf:"bytes,6,opt,name=vote_threshold,json=voteThreshold,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"vote_threshold"`
	Quorum        cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=quorum,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"quorum"`
}
...
var fileDescriptor_b81d271efeb6eee5 = []byte{
	...
	,
}
