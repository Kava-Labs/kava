	...
	suite.cdpCollateralParams = cdptypes.CollateralParams{
		{
			...
			StabilityFee:                     sdkmath.LegacyMustNewDecFromStr("1.02"),
		...
		},
		{
			...
			DebtLimit:                        sdk.NewCoin("usdx", sdkmath.NewInt(100)),
			StabilityFee:                     sdkmath.LegacyMustNewDecFromStr("1.01"),
			LiquidationPenalty:               sdkmath.LegacyMustNewDecFromStr("0.10"),
			...
			KeeperRewardPercentage:           sdkmath.LegacyMustNewDecFromStr("0.12"),
		},
	}
