...
func TestProposalTestSuite(t *testing.T) {
	suite.Run(t, new(lendProposalTestSuite))
}

func (suite *lendProposalTestSuite) SetupTest() {
	app.SetSDKConfig()
	...
	suite.MaccAddress = tApp.GetAccountKeeper().GetModuleAddress(types.ModuleName)
...
func (suite *lendProposalTestSuite) FundCommunityPool(coins sdk.Coins) {
...
func (suite *lendProposalTestSuite) GetCommunityPoolBalance() sdk.Coins {
...
func (suite *lendProposalTestSuite) CheckCommunityPoolBalance(expected sdk.Coins) {
...
func (suite *lendProposalTestSuite) TestCommunityLendWithdrawProposal() {
	testCases := []struct {
		name               string
