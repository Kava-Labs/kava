...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"kavadist", "v1", "parameters"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Balance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"kavadist", "v1", "balance"}, "", runtime.AssumeColonVerbOpt(true)))
)
