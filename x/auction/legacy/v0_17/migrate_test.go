...
type migrateTestSuite struct {
	...
	v15genstate v016auction.GenesisState
	cdc         codec.Codec
...
func (s *migrateTestSuite) SetupTest() {
	...
	s.v15genstate = v016auction.GenesisState{
		NextAuctionID: 1,
		Params:        v016auction.Params{},
		Auctions:      v016auction.GenesisAuctions{},
	}
	...
	v016auction.RegisterLegacyAminoCodec(legacyCodec)
...
// 	testcases := []struct {
// 		name       string
// 		oldAuction v016auction.GenesisAuction
