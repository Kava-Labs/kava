...
import "github.com/kava-labs/kava/x/auction"
...
const ModuleName = auction.ModuleName

func EmptyGenesisState() auction.GenesisState {
	return auction.GenesisState{
		NextAuctionID: auction.DefaultNextAuctionID,
		Params:        auction.Params{}, // TODO how should we set these params, should it be part of migration?
		Auctions:      auction.GenesisAuctions{},
	}
}
