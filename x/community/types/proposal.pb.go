...
type CommunityPoolCDPWithdrawCollateralProposal struct {
	Title          string     `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	Description    string     `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	CollateralType string     `protobuf:"bytes,3,opt,name=collateral_type,json=collateralType,proto3" json:"collateral_type,omitempty"`
...
func (m *CommunityPoolCDPWithdrawCollateralProposal) Reset() {
	*m = CommunityPoolCDPWithdrawCollateralProposal{}
}
func (*CommunityPoolCDPWithdrawCollateralProposal) ProtoMessage() {}
func (*CommunityPoolCDPWithdrawCollateralProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_64aa83b2ed448ec1, []int{3}
}
func (m *CommunityPoolCDPWithdrawCollateralProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CommunityPoolCDPWithdrawCollateralProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CommunityPoolCDPWithdrawCollateralProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CommunityPoolCDPWithdrawCollateralProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CommunityPoolCDPWithdrawCollateralProposal.Merge(m, src)
}
func (m *CommunityPoolCDPWithdrawCollateralProposal) XXX_Size() int {
	return m.Size()
}
func (m *CommunityPoolCDPWithdrawCollateralProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_CommunityPoolCDPWithdrawCollateralProposal.DiscardUnknown(m)
}

var xxx_messageInfo_CommunityPoolCDPWithdrawCollateralProposal proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*CommunityPoolCDPWithdrawCollateralProposal)(nil), "kava.community.v1beta1.CommunityPoolCDPWithdrawCollateralProposal")
}
...
var fileDescriptor_64aa83b2ed448ec1 = []byte{
	...
	,
}
...
func (m *CommunityPoolCDPWithdrawCollateralProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CommunityPoolCDPWithdrawCollateralProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CommunityPoolCDPWithdrawCollateralProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CommunityPoolCDPWithdrawCollateralProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CommunityPoolCDPWithdrawCollateralProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CommunityPoolCDPWithdrawCollateralProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CommunityPoolCDPWithdrawCollateralProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
