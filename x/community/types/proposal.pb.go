...
type CommunityPoolCDPRepayDebtProposal struct {
	Title          string     `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	Description    string     `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
...
func (m *CommunityPoolCDPRepayDebtProposal) Reset()      { *m = CommunityPoolCDPRepayDebtProposal{} }
func (*CommunityPoolCDPRepayDebtProposal) ProtoMessage() {}
func (*CommunityPoolCDPRepayDebtProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_64aa83b2ed448ec1, []int{2}
}
func (m *CommunityPoolCDPRepayDebtProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CommunityPoolCDPRepayDebtProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CommunityPoolCDPRepayDebtProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CommunityPoolCDPRepayDebtProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CommunityPoolCDPRepayDebtProposal.Merge(m, src)
}
func (m *CommunityPoolCDPRepayDebtProposal) XXX_Size() int {
	return m.Size()
}
func (m *CommunityPoolCDPRepayDebtProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_CommunityPoolCDPRepayDebtProposal.DiscardUnknown(m)
}

var xxx_messageInfo_CommunityPoolCDPRepayDebtProposal proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*CommunityPoolCDPRepayDebtProposal)(nil), "kava.community.v1beta1.CommunityPoolCDPRepayDebtProposal")
}
...
var fileDescriptor_64aa83b2ed448ec1 = []byte{
	...
	,
}
...
func (m *CommunityPoolCDPRepayDebtProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CommunityPoolCDPRepayDebtProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CommunityPoolCDPRepayDebtProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CommunityPoolCDPRepayDebtProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CommunityPoolCDPRepayDebtProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CommunityPoolCDPRepayDebtProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CommunityPoolCDPRepayDebtProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
