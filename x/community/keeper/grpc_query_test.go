...
// 	testutil.communityTestSuite

// 	queryClient types.QueryClient
// }

// func (suite *grpcQueryTestSuite) SetupTest() {
// 	suite.communityTestSuite.SetupTest()
...
// 	communityKeeper := app.GetcommunityKeeper()

// 	params, err := queryClient.Params(context.Background(), &types.QueryParamsRequest{})
// 	suite.Require().NoError(err)
// 	suite.Require().Equal(params.Params, communityKeeper.GetParams(ctx))
// }
...
// 			// set desired params
// 			communityKeeper.SetParams(ctx, types.NewParams(tc.communityInflation, tc.stakingApy))
...
// 			suite.Require().NoError(err)
// 			suite.Require().Equal(inflation.Inflation, communityKeeper.CumulativeInflation(ctx))
