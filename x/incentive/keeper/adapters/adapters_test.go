...
func (suite *AdapterTestSuite) SetupTest() {
	...
	suite.adapters = map[types.ClaimType]types.SourceAdapter{
		types.CLAIM_TYPE_HARD_BORROW: hard_borrow.NewSourceAdapter(suite.app.GetHardKeeper()),
		types.CLAIM_TYPE_HARD_SUPPLY: hard_supply.NewSourceAdapter(suite.app.GetHardKeeper()),
		types.CLAIM_TYPE_EARN:        swap.NewSourceAdapter(suite.app.GetSwapKeeper()),
