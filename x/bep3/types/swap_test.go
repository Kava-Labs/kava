	...
	testCases := []struct {
	...
	}{
		{
			...
			types.AtomicSwap{
				...
				ClosedBlock:         1,
				Status:              types.SwapStatus_SWAP_STATUS_OPEN,
				CrossChain:          true,
				Direction:           types.SwapDirection_SWAP_DIRECTION_INCOMING,
			},
			true,
		},
		{
		...
		},
		{
			...
			types.AtomicSwap{
				...
				RecipientOtherChain: "bnb1urfermcg92dwq36572cx4xg84wpk3lfpksr5g7",
				ClosedBlock:         1,
				Status:              types.SwapStatus_SWAP_STATUS_UNSPECIFIED,
			},
			false,
		},
		{
			...
			types.AtomicSwap{
				...
				ClosedBlock:         1,
				Status:              types.SwapStatus_SWAP_STATUS_OPEN,
				Direction:           types.SwapDirection_SWAP_DIRECTION_UNSPECIFIED,
			},
			false,
		},
	}
