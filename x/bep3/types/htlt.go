...
type HTLT struct {
	...
	RandomNumberHash    binance.SwapBytes `json:"random_number_hash"`
	Timestamp           int64             `json:"timestamp"`
	Amount              binance.Coins     `json:"amount"`
...
func NewHTLT(from sdk.AccAddress, to sdk.AccAddress, recipientOtherChain,
	senderOtherChain string, randomNumberHash binance.SwapBytes, timestamp int64,
	amount binance.Coins, expectedIncome string, heightSpan int64, crossChain bool) HTLT {
	return HTLT{
		From:                from,
		To:                  to,
...
func (h HTLT) GetModuleAccountCoins() sdk.Coins {
	// TODO: GetHTLTCoins
	return ConvertBinanceCoins(h.Amount)
}
