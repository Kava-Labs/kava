			...
			MoneyMarkets: v015hard.MoneyMarkets{
				{
					...
					BorrowLimit: v015hard.BorrowLimit{
						HasMaxLimit:  true,
						MaximumLimit: sdkmath.LegacyMustNewDecFromStr("0.1"),
						LoanToValue:  sdkmath.LegacyMustNewDecFromStr("0.2"),
					},
					SpotMarketID:     "spot-market-id",
					ConversionFactor: sdkmath.NewInt(110),
					InterestRateModel: v015hard.InterestRateModel{
						BaseRateAPY:    sdkmath.LegacyMustNewDecFromStr("0.1"),
						BaseMultiplier: sdkmath.LegacyMustNewDecFromStr("0.2"),
						Kink:           sdkmath.LegacyMustNewDecFromStr("0.3"),
						JumpMultiplier: sdkmath.LegacyMustNewDecFromStr("0.4"),
					},
					ReserveFactor:          sdkmath.LegacyMustNewDecFromStr("0.5"),
					KeeperRewardPercentage: sdkmath.LegacyMustNewDecFromStr("0.6"),
				},
			},
		},
		PreviousAccumulationTimes: v015hard.GenesisAccumulationTimes{
			{
				...
				SupplyInterestFactor:     sdkmath.LegacyMustNewDecFromStr("0.1"),
				BorrowInterestFactor:     sdkmath.LegacyMustNewDecFromStr("0.2"),
			},
		},
		Deposits: v015hard.Deposits{
			{
				...
				Index: v015hard.SupplyInterestFactors{
					{
						Denom: "kava",
						Value: sdkmath.LegacyMustNewDecFromStr("1.12"),
					},
				},
			},
		},
