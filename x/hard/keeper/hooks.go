...
func (k Keeper) BeforeDepositModified(ctx sdk.Context, deposit types.Deposit, newDepositDenoms []string) {
	if k.hooks != nil {
		k.hooks.BeforeDepositModified(ctx, deposit, newDepositDenoms)
	}
}
