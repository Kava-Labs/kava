...
// func NewValidatorVestingAccountRaw(bva *authvestingtypes.BaseVestingAccount,
// 	startTime int64, periods authvestingtypes.Periods, validatorAddress sdk.ConsAddress, returnAddress sdk.AccAddress, signingThreshold int64) *ValidatorVestingAccount {

// 	pva := &authvestingtypes.PeriodicVestingAccount{
...
// func NewValidatorVestingAccount(baseAcc *authvestingtypes.BaseAccount, startTime int64, periods authvestingtypes.Periods, validatorAddress sdk.ConsAddress, returnAddress sdk.AccAddress, signingThreshold int64) *ValidatorVestingAccount {

// 	endTime := startTime
// 	for _, p := range periods {
// 		endTime += p.Length
// 	}
// 	baseVestingAcc := &authvestingtypes.BaseVestingAccount{
// 		BaseAccount:     baseAcc,
...
// 		EndTime                int64
// 		StartTime              int64
// 		VestingPeriods         authvestingtypes.Periods
