...
func (suite *keeperTestSuite) TestSupplyLoss() {
	// other tests should cover it, this one just goes through statedb
	suite.T().Skip("skipped to not depend on new ethermint versions")
...
func (suite *keeperTestSuite) TestMintBurnOrder() {
	...
	suite.Require().Equal(
		sdk.NewInt(1).String(),
		bal.Amount.String(),
		"akava should be backed by 1ukava",
	)
	suite.Require().Equal(expAkava, akavaBal.String())
}
...
func (suite *keeperTestSuite) TestBurnAkava() {
