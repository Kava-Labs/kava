...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		gov.NewAppModuleBasic(
			...
			kavadistclient.CommunityPoolMultispendProposalHandler,
			kavadistclient.CommunityPoolLendDepositProposalHandler,
			kavadistclient.CommunityPoolLendWithdrawProposalHandler,
