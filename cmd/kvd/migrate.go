...
// TODO move this to migrate package?
...
var migrationMap = genutil.MigrationMap{
	"v0.8": v0_8.Migrate,
}

// GetMigrationCallback returns a MigrationCallback for a given version.
func GetMigrationCallback(version string) genutil.MigrationCallback {
...
Example:
$ %s migrate v0.8 /path/to/genesis.json --chain-id=new-chain-id --genesis-time=1998-01-01T00:00:00Z
`, version.ServerName),
